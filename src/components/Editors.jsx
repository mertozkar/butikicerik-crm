...
const Editors = () => {
    const { brands, patSearch, setPatSearch, editors } = useSiteContext()
        ...
        <>
            <Row xs="1" className="search-bar mt-5">
                ...
                <Col lg="6" className='text-end'>
                    <button type="button" className="btn btn-primary m-2" onClick={openNewBrandPopup}>Yeni Editör <b>+</b></button>
                </Col>
